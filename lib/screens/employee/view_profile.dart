...
class ViewProfile extends StatefulWidget {
  final  id;
  final  data;
  const ViewProfile({Key? key, required this.id,required this.data}) : super(key: key);
  @override
              ...
              onHorizontalDragUpdate: (details) {
                ...
                if (details.delta.dx > 0 && details.delta.dy == 0) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => EmployeeHome(name:widget.data['name'],id:widget.data['id']
                      ),),);
                }
              },
              child: Column(children: [
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Text(
                      ...
                      '${widget.data['occupation_position_held']}',
                    ...
                    Text(
                      ...
                      '${widget.data['activities_responsibilities']}',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: Color.fromRGBO(58, 54, 115, 1),
                          fontFamily: 'Open Sans',
                ...
                Container(
                  ...
                  child: Column(children: [
                            ...
                            child: Column(children: [
                              ...
                              Row(children: [
                                Text(
                                  ...
                                  '${widget.data['title_of_qualification']}',
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                      color: Color.fromRGBO(58, 54, 115, 1),
                                      fontFamily: 'Open Sans',
                              ...
                              Row(children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      letterSpacing:
                                      0,
                                      fontSize: 10 /*percentages not used in flutter. defaulting to zero*/,
                                      fontWeight: FontWeight.normal,
                                      height: 1),
                                )
                              ]),
                    ...
                    Row(children: [
                      Text(
                        'Gallary', textAlign: TextAlign.left, style: TextStyle(
                          color: Color.fromRGBO(255, 255, 255, 1),
                          fontFamily: 'Roboto',
                          fontSize: 12,
